    ...
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastGenericDeserializerGeneratorTest_shouldReadEnum_GenericDeserializer_695378847_695378847(Schema readerSchema, GenericData modelData) {
        ...
        throws IOException
    {
        ...
        if ((((reuse)!= null)&&((reuse) instanceof IndexedRecord))&&(((IndexedRecord)(reuse)).getSchema() == readerSchema)) {
            ...
            FastGenericDeserializerGeneratorTest_shouldReadEnum = new GenericData.Record(readerSchema);
        }
        FastGenericDeserializerGeneratorTest_shouldReadEnum.put(0, new GenericData.EnumSymbol(testEnum0, testEnum0 .getEnumSymbols().get((decoder.readEnum()))));
        ...
        throws IOException
    {
        ...
        if (unionIndex0 == 0) {
            ...
            if (unionIndex0 == 1) {
                FastGenericDeserializerGeneratorTest_shouldReadEnum.put(1, new GenericData.EnumSymbol(testEnum0, testEnum0 .getEnumSymbols().get((decoder.readEnum()))));
            } else {
        ...
        if (oldArray0 instanceof List) {
            ...
            testEnumArray1 = new GenericData.Array<GenericEnumSymbol>(((int) chunkLen0), testEnumArray0);
        }
        while (chunkLen0 > 0) {
            for (int counter0 = 0; (counter0 <chunkLen0); counter0 ++) {
                testEnumArray1 .add(new GenericData.EnumSymbol(testEnum0, testEnum0 .getEnumSymbols().get((decoder.readEnum()))));
            }
        ...
        throws IOException
    {
        ...
        if (oldArray1 instanceof List) {
            ...
            testEnumUnionArray1 = new GenericData.Array<GenericEnumSymbol>(((int) chunkLen1), testEnumUnionArray0);
        }
        while (chunkLen1 > 0) {
            for (int counter1 = 0; (counter1 <chunkLen1); counter1 ++) {
                ...
                if (unionIndex1 == 0) {
                    ...
                    if (unionIndex1 == 1) {
                        testEnumUnionArray1 .add(new GenericData.EnumSymbol(testEnum0, testEnum0 .getEnumSymbols().get((decoder.readEnum()))));
                    } else {
