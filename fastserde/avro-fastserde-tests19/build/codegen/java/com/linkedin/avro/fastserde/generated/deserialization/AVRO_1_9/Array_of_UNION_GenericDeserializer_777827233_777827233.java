    ...
    implements FastDeserializer<List<IndexedRecord>>
{
    ...
    public Array_of_UNION_GenericDeserializer_777827233_777827233(Schema readerSchema, GenericData modelData) {
        ...
        throws IOException
    {
        ...
        if ((((reuse)!= null)&&((reuse) instanceof IndexedRecord))&&(((IndexedRecord)(reuse)).getSchema() == arrayElemOptionSchema0)) {
            ...
            record = new GenericData.Record(arrayElemOptionSchema0);
        }
