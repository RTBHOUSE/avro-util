    ...
    implements FastSerializer<IndexedRecord>
{
        ...
        throws IOException
    {
        ...
        if (testEnumUnion0 == null) {
            ...
            if ((testEnumUnion0 instanceof GenericEnumSymbol)&&"com.adpilot.utils.generated.avro.testEnum".equals(((GenericEnumSymbol) testEnumUnion0).getSchema().getFullName())) {
        ...
        if ((testEnumUnionArray0 == null)||testEnumUnionArray0 .isEmpty()) {
            ...
            for (int counter1 = 0; (counter1 <testEnumUnionArray0 .size()); counter1 ++) {
                ...
                if (union0 == null) {
                    ...
                    if ((union0 instanceof GenericEnumSymbol)&&"com.adpilot.utils.generated.avro.testEnum".equals(((GenericEnumSymbol) union0).getSchema().getFullName())) {
                        (encoder).writeIndex(1);
                        int valueToWrite3;
