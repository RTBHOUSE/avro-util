    ...
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastSerdeLogicalTypesTest1_GenericDeserializer_1007574890_1007574890(Schema readerSchema, GenericData modelData) {
        ...
        throws IOException
    {
        ...
        if (unionIndex2 == 0) {
            ...
            if (unionIndex2 == 1) {
                ...
                if (oldArray1 instanceof List) {
                    ...
                    nullableArrayOfDatesOption0 = new GenericData.Array<LocalDate>(((int) chunkLen4), nullableArrayOfDatesOptionSchema0);
                }
                while (chunkLen4 > 0) {
        ...
        if (oldArray2 instanceof List) {
            ...
            arrayOfDates0 = new GenericData.Array<LocalDate>(((int) chunkLen5), nullableArrayOfDatesOptionSchema0);
        }
        while (chunkLen5 > 0) {
        ...
        throws IOException
    {
        ...
        FastSerdeLogicalTypesTest1 .put(7, convertedValue10);
        ...
        throws IOException
    {
        ...
        FastSerdeLogicalTypesTest1 .put(9, convertedValue12);
        ...
        throws IOException
    {
        ...
        if (unionIndex4 == 0) {
            ...
            if (unionIndex4 == 1) {
                ...
                LocalTimestampRecord.put(1, convertedValue16);
            } else {
        ...
        if (unionIndex5 == 0) {
            ...
            if (unionIndex5 == 1) {
                ...
                if (unionIndex5 == 2) {
                    ...
                    LocalTimestampRecord.put(2, convertedValue18);
                } else {
        ...
        throws IOException
    {
        ...
        if (unionIndex6 == 0) {
            ...
            if (unionIndex6 == 1) {
                ...
                LocalTimestampRecord.put(3, convertedValue20);
            } else {
