...
public class FastGenericDeserializerGeneratorTest_shouldTolerateUnionReorderingWithSubRecords_GenericDeserializer_524692447_963368136
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastGenericDeserializerGeneratorTest_shouldTolerateUnionReorderingWithSubRecords_GenericDeserializer_524692447_963368136(Schema readerSchema, GenericData modelData) {
        ...
        throws IOException
    {
        ...
        if ((((reuse)!= null)&&((reuse) instanceof IndexedRecord))&&(((IndexedRecord)(reuse)).getSchema() == testOptionSchema0)) {
            ...
            subRecord1 = new GenericData.Record(testOptionSchema0);
        }
        ...
        throws IOException
    {
        ...
        if ((((reuse)!= null)&&((reuse) instanceof IndexedRecord))&&(((IndexedRecord)(reuse)).getSchema() == testOptionSchema1)) {
            ...
            subRecord2 = new GenericData.Record(testOptionSchema1);
        }
