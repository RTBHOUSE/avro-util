    ...
    implements FastDeserializer<com.linkedin.avro.fastserde.generated.avro.FastSerdeLogicalTypesTest1>
{
    ...
    public FastSerdeLogicalTypesTest1_SpecificDeserializer_814567178_814567178(Schema readerSchema, SpecificData modelData) {
        ...
        throws IOException
    {
        ...
        if (chunkLen2 > 0) {
            ...
            if (timestampMillisMapReuse0 != (null)) {
                ...
                timestampMillisMap0 = new HashMap<Utf8, Instant>(((int)(((chunkLen2 * 4)+ 2)/ 3)));
            }
            do {
                for (int counter2 = 0; (counter2 <chunkLen2); counter2 ++) {
                    ...
                    timestampMillisMap0 .put(key1, convertedValue2);
                }
        ...
        if (unionIndex1 == 0) {
            ...
            if (unionIndex1 == 1) {
                ...
                if (oldArray1 instanceof List) {
                    ...
                    nullableArrayOfDatesOption0 = new ArrayList<LocalDate>(((int) chunkLen3));
                }
                while (chunkLen3 > 0) {
        ...
        throws IOException
    {
        ...
        if (oldArray2 instanceof List) {
            ...
            arrayOfDates0 = new ArrayList<LocalDate>(((int) chunkLen4));
        }
        while (chunkLen4 > 0) {
        ...
        throws IOException
    {
        ...
        UUID convertedValue7 = ((UUID) Conversions.convertToLogicalType(charSequence0, this.logicalTypeSchema__1245572876, this.logicalTypeSchema__1245572876 .getLogicalType(), this.conversion_uuid));
        FastSerdeLogicalTypesTest1 .put(5, convertedValue7);
        Instant convertedValue8 = ((Instant) Conversions.convertToLogicalType((decoder.readLong()), this.logicalTypeSchema_1074306973, this.logicalTypeSchema_1074306973 .getLogicalType(), this.conversion_timestamp_millis));
        FastSerdeLogicalTypesTest1 .put(6, convertedValue8);
    }
    ...
    private void populate_FastSerdeLogicalTypesTest13(com.linkedin.avro.fastserde.generated.avro.FastSerdeLogicalTypesTest1 FastSerdeLogicalTypesTest1, Decoder decoder)
        throws IOException
    {
        Instant convertedValue9 = ((Instant) Conversions.convertToLogicalType((decoder.readLong()), this.logicalTypeSchema__1252781617, this.logicalTypeSchema__1252781617 .getLogicalType(), this.conversion_timestamp_micros));
        FastSerdeLogicalTypesTest1 .put(7, convertedValue9);
        LocalTime convertedValue10 = ((LocalTime) Conversions.convertToLogicalType((decoder.readInt()), this.logicalTypeSchema__419105534, this.logicalTypeSchema__419105534 .getLogicalType(), this.conversion_time_millis));
    ...
    private void populate_FastSerdeLogicalTypesTest14(com.linkedin.avro.fastserde.generated.avro.FastSerdeLogicalTypesTest1 FastSerdeLogicalTypesTest1, Decoder decoder)
        throws IOException
    {
        LocalTime convertedValue11 = ((LocalTime) Conversions.convertToLogicalType((decoder.readLong()), this.logicalTypeSchema__1515894331, this.logicalTypeSchema__1515894331 .getLogicalType(), this.conversion_time_micros));
        ...
        throws IOException
    {
        ...
        LocalDateTime convertedValue13 = ((LocalDateTime) Conversions.convertToLogicalType((decoder.readLong()), this.logicalTypeSchema__250645780, this.logicalTypeSchema__250645780 .getLogicalType(), this.conversion_local_timestamp_millis));
        LocalTimestampRecord.put(0, convertedValue13);
        ...
        throws IOException
    {
        ...
        if (unionIndex3 == 0) {
            ...
            if (unionIndex3 == 1) {
                ...
                LocalTimestampRecord.put(1, convertedValue14);
            } else {
        ...
        if (unionIndex4 == 0) {
            ...
            if (unionIndex4 == 1) {
                ...
                LocalTimestampRecord.put(2, convertedValue15);
            } else {
                if (unionIndex4 == 2) {
        ...
        throws IOException
    {
        ...
        if (unionIndex5 == 0) {
            ...
            LocalTimestampRecord.put(3, convertedValue17);
        } else {
            if (unionIndex5 == 1) {
