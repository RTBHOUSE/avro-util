...
public class Map_of_UNION_SpecificDeserializer_971650236_971650236
    implements FastDeserializer<Map<Utf8, com.linkedin.avro.fastserde.generated.avro.TestRecord>>
{

    private final Schema readerSchema;
    private final SpecificData modelData;

    public Map_of_UNION_SpecificDeserializer_971650236_971650236(Schema readerSchema, SpecificData modelData) {
        ...
        throws IOException
    {
        ...
        if (unionIndex1 == 0) {
            ...
            if (unionIndex1 == 1) {
                ...
                throw new RuntimeException(("Illegal union index for 'testIntUnion': "+ unionIndex1));
            }
        }
        ...
        throws IOException
    {
        ...
        if (unionIndex15 == 0) {
            ...
            if (unionIndex15 == 1) {
                ...
                throw new RuntimeException(("Illegal union index for 'recordsArrayUnion': "+ unionIndex15));
            }
        }
    }
        ...
        throws IOException
    {
        ...
        if (unionIndex17 == 0) {
            ...
            if (unionIndex17 == 1) {
                ...
                throw new RuntimeException(("Illegal union index for 'recordsMapUnion': "+ unionIndex17));
            }
        }
        ...
        throws IOException
    {
        ...
        if (chunkLen11 > 0) {
            ...
            do {
                for (int counter11 = 0; (counter11 <chunkLen11); counter11 ++) {
                    ...
                    recordsMapArray0 .put(key4, recordsMapArrayValue0);
                }
        ...
        if (unionIndex21 == 0) {
            ...
            if (unionIndex21 == 1) {
                ...
                throw new RuntimeException(("Illegal union index for 'recordsArrayMapUnion': "+ unionIndex21));
            }
        }
    }
        ...
        throws IOException
    {
        ...
        if (unionIndex23 == 0) {
            ...
            if (unionIndex23 == 1) {
                ...
                if (chunkLen15 > 0) {
                    ...
                    do {
                        for (int counter15 = 0; (counter15 <chunkLen15); counter15 ++) {
                            ...
                            recordsMapArrayUnionOption0 .put(key6, recordsMapArrayUnionOptionValue0);
                        }
                ...
                throw new RuntimeException(("Illegal union index for 'recordsMapArrayUnion': "+ unionIndex23));
            }
        }
            ...
            if (unionIndex25 == 1) {
                ...
                if (unionIndex25 == 2) {
                    ...
                    if (unionIndex25 == 3) {
                        ...
                        throw new RuntimeException(("Illegal union index for 'union': "+ unionIndex25));
                    }
                }
            }
        }
