    ...
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastGenericDeserializerGeneratorTest_shouldReadFixed_GenericDeserializer_1590965143_1590965143(Schema readerSchema, GenericData modelData) {
        ...
        throws IOException
    {
        ...
        if (oldArray0 instanceof List) {
            ...
            testFixedArray1 = new GenericData.Array<GenericFixed>(((int) chunkLen0), testFixedArray0);
        }
        while (chunkLen0 > 0) {
        ...
        throws IOException
    {
        ...
        if (oldArray1 instanceof List) {
            ...
            testFixedUnionArray1 = new GenericData.Array<GenericFixed>(((int) chunkLen1), testFixedUnionArray0);
        }
        while (chunkLen1 > 0) {
