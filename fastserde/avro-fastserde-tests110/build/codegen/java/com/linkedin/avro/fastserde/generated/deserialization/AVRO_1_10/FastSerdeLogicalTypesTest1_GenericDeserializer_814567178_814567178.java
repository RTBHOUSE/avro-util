    ...
    implements FastDeserializer<IndexedRecord>
{
    ...
    public FastSerdeLogicalTypesTest1_GenericDeserializer_814567178_814567178(Schema readerSchema) {
        ...
        throws IOException
    {
        ...
        if (chunkLen2 > 0) {
            ...
            if (timestampMillisMapReuse0 != (null)) {
                ...
                timestampMillisMap1 = new HashMap<Utf8, Long>(((int)(((chunkLen2 * 4)+ 2)/ 3)));
            }
            do {
                for (int counter2 = 0; (counter2 <chunkLen2); counter2 ++) {
                    Utf8 key1 = (decoder.readString(null));
                    timestampMillisMap1 .put(key1, (decoder.readLong()));
                }
