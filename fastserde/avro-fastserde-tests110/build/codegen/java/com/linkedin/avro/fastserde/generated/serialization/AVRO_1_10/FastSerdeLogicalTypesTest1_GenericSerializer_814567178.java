...
public class FastSerdeLogicalTypesTest1_GenericSerializer_814567178
    implements FastSerializer<IndexedRecord>
{
    ...
    public FastSerdeLogicalTypesTest1_GenericSerializer_814567178(GenericData modelData) {
        ...
        throws IOException
    {
        ...
        if (((CharSequence) data.get(5)) instanceof Utf8) {
            (encoder).writeString(((Utf8)((CharSequence) data.get(5))));
        } else {
            (encoder).writeString(((CharSequence) data.get(5)).toString());
        }
        Object convertedValue10 = data.get(6);
        convertedValue10 = Conversions.convertToRawType(convertedValue10, this.logicalTypeSchema_1074306973, this.logicalTypeSchema_1074306973 .getLogicalType(), this.conversion_timestamp_millis);
        (encoder).writeLong(((Long) convertedValue10));
        Object convertedValue11 = data.get(7);
        convertedValue11 = Conversions.convertToRawType(convertedValue11, this.logicalTypeSchema__1252781617, this.logicalTypeSchema__1252781617 .getLogicalType(), this.conversion_timestamp_micros);
        (encoder).writeLong(((Long) convertedValue11));
        Object convertedValue12 = data.get(8);
        convertedValue12 = Conversions.convertToRawType(convertedValue12, this.logicalTypeSchema__419105534, this.logicalTypeSchema__419105534 .getLogicalType(), this.conversion_time_millis);
        (encoder).writeInt(((Integer) convertedValue12));
        Object convertedValue13 = data.get(9);
        convertedValue13 = Conversions.convertToRawType(convertedValue13, this.logicalTypeSchema__1515894331, this.logicalTypeSchema__1515894331 .getLogicalType(), this.conversion_time_micros);
        (encoder).writeLong(((Long) convertedValue13));
        Object convertedValue14 = data.get(10);
        convertedValue14 = Conversions.convertToRawType(convertedValue14, this.logicalTypeSchema__59052268, this.logicalTypeSchema__59052268 .getLogicalType(), this.conversion_date);
        (encoder).writeInt(((Integer) convertedValue14));
        IndexedRecord nestedLocalTimestampMillis0 = ((IndexedRecord) data.get(11));
    ...
    public void serializeLocalTimestampRecord0(IndexedRecord data, Encoder encoder)
        throws IOException
    {
        Object convertedValue15 = data.get(0);
        convertedValue15 = Conversions.convertToRawType(convertedValue15, this.logicalTypeSchema__250645780, this.logicalTypeSchema__250645780 .getLogicalType(), this.conversion_local_timestamp_millis);
        ...
        if (nullableNestedTimestamp0 == null) {
            ...
            (encoder).writeIndex(1);
            Object convertedValue16 = nullableNestedTimestamp0;
        ...
        if (unionOfDateAndLocalTimestamp0 instanceof LocalDate) {
            (encoder).writeIndex(0);
            Object convertedValue19 = unionOfDateAndLocalTimestamp0;
