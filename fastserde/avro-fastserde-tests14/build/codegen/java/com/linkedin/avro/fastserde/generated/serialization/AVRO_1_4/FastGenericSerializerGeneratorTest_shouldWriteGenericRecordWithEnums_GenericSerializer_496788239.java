    ...
    implements FastSerializer<IndexedRecord>
{
    ...
    private final Schema testEnumEnumSchema0 = Schema.parse("{\"type\":\"enum\",\"name\":\"testEnum\",\"namespace\":\"com.linkedin.avro.fastserde.generated.avro\",\"symbols\":[\"A\",\"B\"]}");
        ...
        throws IOException
    {
        ...
        if (enumValue0 instanceof Enum) {
            ...
            valueToWrite0 = testEnumEnumSchema0 .getEnumOrdinal(((GenericEnumSymbol) data.get(0)).toString());
        }
        ...
        throws IOException
    {
        ...
        if (testEnumUnion0 == null) {
            ...
            if (enumValue1 instanceof Enum) {
                ...
                valueToWrite1 = testEnumEnumSchema0 .getEnumOrdinal(((GenericEnumSymbol) testEnumUnion0).toString());
            }
        ...
        if ((testEnumArray0 == null)||testEnumArray0 .isEmpty()) {
            ...
            for (int counter0 = 0; (counter0 <testEnumArray0 .size()); counter0 ++) {
                ...
                if (enumValue2 instanceof Enum) {
                    ...
                    valueToWrite2 = testEnumEnumSchema0 .getEnumOrdinal(((GenericEnumSymbol) testEnumArray0 .get(counter0)).toString());
                }
            ...
            for (int counter1 = 0; (counter1 <testEnumUnionArray0 .size()); counter1 ++) {
                ...
                if (union0 == null) {
                    ...
                    if (enumValue3 instanceof Enum) {
                        ...
                        valueToWrite3 = testEnumEnumSchema0 .getEnumOrdinal(((GenericEnumSymbol) union0).toString());
                    }
